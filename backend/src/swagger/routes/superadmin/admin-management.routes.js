/**
 * Documentation Swagger pour la gestion des administrateurs (Super Admin)
 * 
 * @swagger
 * tags:
 *   name: Super Admin - Admin Management
 *   description: Gestion des administrateurs par le Super Admin
 */
 ...
 *                 type: string
 *                 format: email
 *                 description: Email du Super Admin
 *               password:
 *                 type: string
 *                 format: password
 *                 description: Mot de passe du Super Admin
 *     responses:
 *       200:
 ...
 *                 items:
 *                   type: string
 *                   enum: [manage_users, manage_residences, manage_bookings, manage_payments, manage_reviews]
 *                 description: Permissions de l'administrateur
 *     responses:
 *       201:
