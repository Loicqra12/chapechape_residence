...
class AppConfigManager {
  ...
  // Fallback prod (branche Play Store) — évite une IP locale si la config est vide
  static String get apiUrl =>
      _config['apiUrl'] as String? ?? 'https://api.chapechaperesidence.com/api';
  static String get apiBaseUrl =>
      _config['apiBaseUrl'] as String? ?? 'https://api.chapechaperesidence.com';
  static String get wsUrl =>
      _config['wsUrl'] as String? ?? 'wss://api.chapechaperesidence.com/ws';
  ...
  static String get appVersion => _config['appVersion'] as String? ?? '1.11.5';
