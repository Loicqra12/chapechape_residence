  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ y }}
      >
        <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg%20width%3D%2260%22%20height%3D%2260%22%20viewBox%3D%220%200%2060%2060%22%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%3E%3Cg%20fill%3D%22none%22%20fill-rule%3D%22evenodd%22%3E%3Cg%20fill%3D%22%23000000%22%20fill-opacity%3D%221%22%3E%3Cpath%20d%3D%22M36%2034v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6%2034v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6%204V0H4v4H0v2h4v4h2V6h4V4H6z%22/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] bg-repeat"></div>
      </motion.div>
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            <span className="text-primary-600 text-xs font-bold tracking-widest uppercase">Processus Simple</span>
          </motion.div>

          <motion.h2
            className="text-4xl md:text-5xl lg:text-6xl font-bold text-secondary-900 mb-6 font-display tracking-tight"
        ...
        >
          {steps.map((step, index) => (
            ...
            >
              ...
              <motion.div
                className={`relative flex flex-col lg:flex-row items-center gap-8 p-8 rounded-2xl ${index % 2 === 0 ? 'lg:text-left' : 'lg:flex-row-reverse lg:text-right'
                  } bg-white border border-primary-100/50 shadow-lg hover:shadow-gold transition-all duration-500 cursor-pointer overflow-hidden group`}
                whileHover="hover"
              >
                {/* Glow effect premium */}
                <motion.div
                  className="absolute -inset-4 bg-gradient-to-r from-primary-50 via-white to-primary-50 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"
                />
                ...
                >
                  <div className="w-full h-full bg-gradient-to-br from-secondary-900 to-transparent rounded-full"></div>
                </motion.div>

                {/* Icône premium animée */}
                <motion.div
                  className="relative w-24 h-24 flex-shrink-0 rounded-2xl bg-primary-50 border border-primary-100 flex items-center justify-center shadow-md"
                ...
                >
                  {/* Numéro d'étape */}
                  <motion.div
                    className="absolute -top-2 -right-2 w-8 h-8 bg-primary-500 rounded-full flex items-center justify-center text-white text-sm font-bold shadow-lg z-20"
                    animate={{
                      scale: [1, 1.1, 1],
                      boxShadow: [
                        "0 0 0 0 rgba(212, 175, 55, 0.4)",
                  ...
                  {/* Icône SVG */}
                  <motion.div
                    className="relative text-primary-600 z-10"
                    variants={iconVariants}
                  >
                    {step.icon === "download" && (
