          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-medium text-gray-800 mb-2">ChapeChape Client</h3>
                ...
                <div>
                  <h3 className="text-xl font-medium text-gray-800 mb-2">ChapeChape Partner</h3>
                  <p className="text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">3. Conditions d'Utilisation</h2>
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-medium text-gray-800 mb-2">Âge minimum</h3>
                  <p className="text-gray-700">
                ...
                <div>
                  <h3 className="text-xl font-medium text-gray-800 mb-2">Compte utilisateur</h3>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">4. Réservations et Paiements</h2>
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-medium text-gray-800 mb-2">Processus de réservation</h3>
                  <ul className="list-disc list-inside text-gray-700 space-y-1">
                ...
                <div>
                  <h3 className="text-xl font-medium text-gray-800 mb-2">Méthodes de paiement</h3>
                  <p className="text-gray-700">
                ...
                <div>
                  <h3 className="text-xl font-medium text-gray-800 mb-2">Politique d'annulation</h3>
                  <p className="text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. Comportement Interdit</h2>
              <p className="text-gray-700 mb-4">Il est strictement interdit de :</p>
