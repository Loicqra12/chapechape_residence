        ...
        >
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">1. Qui nous sommes</h2>
              ...
              <div className="bg-blue-50 p-4 rounded-lg mt-4">
                <p className="text-gray-700">
                  <strong>Contact :</strong> <a href="mailto:contact@chapechaperesidence.com" className="text-blue-600 hover:underline">contact@chapechaperesidence.com</a>
                </p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-medium text-gray-800 mb-2">Informations d'identification</h3>
                ...
                <div>
                  <h3 className="text-xl font-medium text-gray-800 mb-2">Données de localisation</h3>
                  <ul className="list-disc list-inside text-gray-700 space-y-1">
                ...
                <div>
                  <h3 className="text-xl font-medium text-gray-800 mb-2">Informations de réservation</h3>
                  <ul className="list-disc list-inside text-gray-700 space-y-1">
                ...
                <div>
                  <h3 className="text-xl font-medium text-gray-800 mb-2">Données de paiement</h3>
                  <ul className="list-disc list-inside text-gray-700 space-y-1">
                ...
                <div>
                  <h3 className="text-xl font-medium text-gray-800 mb-2">Données techniques</h3>
                  <ul className="list-disc list-inside text-gray-700 space-y-1">
                ...
                <div>
                  <h3 className="text-xl font-medium text-gray-800 mb-2">Données spécifiques à l'app Partner</h3>
                  <ul className="list-disc list-inside text-gray-700 space-y-1">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">Nous partageons vos données uniquement avec :</p>
              <ul className="list-disc list-inside text-gray-700 space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">7. Conservation et Protection des Données</h2>
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-medium text-gray-800 mb-2">Durée de conservation</h3>
                  <ul className="list-disc list-inside text-gray-700 space-y-1">
                ...
                <div>
                  <h3 className="text-xl font-medium text-gray-800 mb-2">Protection des données</h3>
                  <ul className="list-disc list-inside text-gray-700 space-y-1">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">8. Publicité</h2>
              <p className="text-gray-700">
            ...
            <section className="mb-8">
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <p className="text-gray-700 mb-2">
                  Email : <a href="mailto:contact@chapechaperesidence.com" className="text-blue-600 hover:underline">contact@chapechaperesidence.com</a>
                </p>
                <p className="text-gray-700 mb-2">
                  Support : <a href="mailto:support@chapechaperesidence.com" className="text-blue-600 hover:underline">support@chapechaperesidence.com</a>
                </p>
                <p className="text-gray-700">
                  Site web : <a href="https://presentation.chapechaperesidence.com" className="text-blue-600 hover:underline">presentation.chapechaperesidence.com</a>
                </p>
              </div>
            </section>
          </div>
