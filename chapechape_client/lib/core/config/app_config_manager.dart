      ...
      switch (_environment) {
        case Environment.dev:
          ...
          if (_useCustomServerUrl && _ipDetectionService != null) {
            ...
            _config = {
              'appName': 'ChapeChape Client (Dev)',
              'apiUrl': '${_useSecureConnection ? 'https' : 'http'}://192.168.1.78:4000/api',
              'apiBaseUrl': '${_useSecureConnection ? 'https' : 'http'}://192.168.1.78:4000',
              'mediaBaseUrl': '${_useSecureConnection ? 'https' : 'http'}://192.168.1.78:4000/media',
              'wsUrl': '${_useSecureConnection ? 'wss' : 'ws'}://192.168.1.78:4000/ws',
              'apiVersion': 'v1',
              'apiTimeout': 30000,
              'wsReconnectInterval': 5000,
              'appVersion': '1.0.0-dev',
