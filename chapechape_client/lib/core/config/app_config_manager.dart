...
class AppConfigManager {
      ...
      switch (_environment) {
        case Environment.dev:
          ...
          if (_useCustomServerUrl && _ipDetectionService != null) {
            ...
            _config = {
              'appName': 'ChapeChape Client (Dev)',
              'apiUrl': '${_useSecureConnection ? 'https' : 'http'}://192.168.1.73:4000/api',
              'apiBaseUrl': '${_useSecureConnection ? 'https' : 'http'}://192.168.1.73:4000',
              'mediaBaseUrl': '${_useSecureConnection ? 'https' : 'http'}://192.168.1.73:4000/media',
              'wsUrl': '${_useSecureConnection ? 'wss' : 'ws'}://192.168.1.73:4000/ws',
              'apiVersion': 'v1',
              'apiTimeout': 30000,
              'wsReconnectInterval': 5000,
              'appVersion': '1.0.0-dev',
  ...
  static String get apiUrl => _config['apiUrl'] as String? ?? 'http://192.168.1.73:4000/api';
  static String get apiBaseUrl => _config['apiBaseUrl'] as String? ?? 'http://192.168.1.73:4000';
  static String get mediaBaseUrl => _config['mediaBaseUrl'] as String? ?? 'http://192.168.1.73:4000/media';
  static String get wsUrl => _config['wsUrl'] as String? ?? 'ws://192.168.1.73:4000/ws';
  ...
  static String get serverIp => _ipDetectionService?.serverIp ?? '192.168.1.73';
