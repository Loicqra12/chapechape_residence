...
class AppConfigManager {
        ...
        case Environment.dev:
          ...
          if (_useCustomServerUrl && _ipDetectionService != null) {
            ...
            _config = {
              ...
              'mediaBaseUrl': '${_useSecureConnection ? 'https' : 'http'}://192.168.1.77:4000/media',
  ...
  static String get mediaBaseUrl => _config['mediaBaseUrl'] as String? ?? 'http://192.168.1.77:4000/media';
